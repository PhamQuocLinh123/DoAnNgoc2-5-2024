...
<head>
    ...
    <title>Thêm Dự Thi (Cơ Bản)</title>
    <!-- Bootstrap CSS -->
...
<body>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header text-center">Thêm Dự Thi (Cơ Bản)</div>
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('du_thi.store') }}">
                            @csrf

                            <div class="form-group">
                                <label for="id_hoc_vien_dau">Học Viên Đầu (Cơ Bản):</label>
                            ...
                            <div class="form-group">
                                <label for="id_hoc_vien_cuoi">Học Viên Cuối (Cơ Bản):</label>
