            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <!-- Thêm nút "Thêm học viên" -->
                        <div class="mb-3">
                            <a href="{{ route('hoc_vien.create') }}" class="btn btn-success">Thêm học viên</a>
                        </div>
                        <div class="mb-3">
                            <a href="{{ route('hoc_vien.import') }}" class="btn btn-success">Thêm học viên bằng Excel</a>
                        </div>
